...
namespace SimpleParser.Tests
{
    ...
    public class ApprovalTests
    {
        ...
        public void RefactoringRegression_ValidFormulas()
        {
            ...
            var approved = System.IO.File.ReadAllText("ApprovalTests.RefactoringRegression_ValidFormulas.approved.txt");

            Assert.AreEqual(approved, sb.ToString());
        }
        ...
        public void RefactoringRegression_InvalidFormulas()
        {
            ...
            var approved = System.IO.File.ReadAllText("ApprovalTests.RefactoringRegression_InvalidFormulas.approved.txt");
